...
func (r *RequestOptions) ToHeader() http.Header {
	...
	header.Set("private-app-legacy", fmt.Sprintf("%v", r.PrivateAppLegacy))
	header.Set("private-app", fmt.Sprintf("%v", r.PrivateApp))
	return header
}
...
// PrivateAppLegacyOption implements the RequestOption interface.
type PrivateAppLegacyOption struct {
	PrivateAppLegacy string
}

func (p *PrivateAppLegacyOption) applyRequestOptions(opts *RequestOptions) {
	opts.PrivateAppLegacy = p.PrivateAppLegacy
}

// PrivateAppOption implements the RequestOption interface.
type PrivateAppOption struct {
	PrivateApp string
}

func (p *PrivateAppOption) applyRequestOptions(opts *RequestOptions) {
	opts.PrivateApp = p.PrivateApp
}
