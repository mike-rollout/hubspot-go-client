...
// WithPrivateAppLegacy sets the privateAppLegacy request header.
func WithPrivateAppLegacy(privateAppLegacy string) *core.PrivateAppLegacyOption {
	return &core.PrivateAppLegacyOption{
		PrivateAppLegacy: privateAppLegacy,
	}
}

// WithPrivateApp sets the privateApp request header.
func WithPrivateApp(privateApp string) *core.PrivateAppOption {
	return &core.PrivateAppOption{
